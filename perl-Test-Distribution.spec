...
wszystkich modu³ach w dystrybucji, sprawdzaj±c ich POD, czy siê
poprawnie kompiluj± oraz czy wszystkie definiuj± $VERSION.

Ten modu³ wykonuje tak¿e testy na samej dystrybucji. Sprawdza, czy
pliki zgadzaj± siê z plikiem SIGNATURE, je¶li takowy istnieje.
Sprawdza, czy w dystrybucji nie brakuje jakich¶ g³ównych plików z
opisem. Sprawdza, czy nie zapomniano wymieniæ wszystkich zale¿no¶ci w
Makefile.PL.
